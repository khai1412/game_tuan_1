class Man1 extends Phaser.Scene {
    ...
    preload() {
        this.load.image("background", "client/assets/1.png");
        this.load.image("background_1", "client/assets/2.png");
        this.load.image("back_khai", "client/assets/7.png");
        this.load.audio("khai_audio", "client/assets/khai.m4a");
        this.load.image("back_huyen", "client/assets/5.png");
        this.load.audio("audio_huyen", "client/assets/huyen.mp3");
        this.load.image("back_kimanh", "client/assets/3.png");
        this.load.image("back_thao", "client/assets/4.png");
        this.load.audio("thaodp_audio", "client/assets/thaodp.m4a");
        this.load.image("back_vu", "client/assets/6.png");
        this.load.audio("vu_audio", "client/assets/sound_vu.mp3");
        this.load.audio("kimanh_audio", "client/assets/kimanh.mp3");
        this.load.spritesheet("wolf", "client/assets/wolf.png", {
            frameWidth: 48,
            frameHeight: 48,
        });
        this.load.audio("man1_background", "client/assets/man1_background.mp3");
    }
    create() {
        // background co ban
        this.man1_background = this.sound.add("man1_background", {
            volume: 0.2,
            loop: false,
        });
        ...
        // source cua kim anh
        this.back_kimanh = this.add
            .image(207, 211, "back_kimanh")
            .setOrigin(0, 0)
            .setScale(34 / 75)
            .setVisible(false);
        this.kimanh_audio = this.sound.add("kimanh_audio", { loop: false });
        // source cua huyen
        this.back_huyen = this.add
            .image(207, 211, "back_huyen")
            .setOrigin(0, 0)
            .setScale(34 / 75)
            .setVisible(false);
        this.audio_huyen = this.sound.add("audio_huyen", { loop: false });
        //create by thaodp
        this.back_thao = this.add
            .image(207, 211, "back_thao")
            .setOrigin(0, 0)
            .setScale(34 / 75)
            .setVisible(false);
